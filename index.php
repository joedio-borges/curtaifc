  ...
  <header id="header">
    ...
    <nav id="nav">
      ...
      <ul id="menu" role="menu">
        ...
        <li><a class="link-menu" href="login.html"><i class="fas fa-sign-in-alt"></i></a></li>
      </ul>
    </nav>
  </header>
    ...
    <div class="row">
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo '<tr><td>'.$row["titulo"].'</td><td><iframe width="560" height="315" src="https://www.youtube.com/embed/'.$row['video'].'?modestbranding=1" 
            rameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
            allowfullscreen></iframe><br><a href='.$url.">".$url."</a></td><td>".$row["imagem"].'</td><td>'.$row["sinopse"]."</td><td>".$row["duracao"]."</td></tr>";
        }
        echo "</table>";
      } else {
        echo "0 results";
